...
(function(){
  ...
  async function saveToDisk(obj) {
    ...
    try { if (typeof isDebugMode !== 'undefined' && isDebugMode) console.warn('[Options] Neutralino not available; settings not persisted to disk'); } catch (e) {}
  }
  ...
  async function loadFromDisk() {
    ...
    try { if (typeof isDebugMode !== 'undefined' && isDebugMode) console.warn('[Options] Neutralino not available; settings not loaded from disk'); } catch (e) {}
    return null;
  }
  ...
  addFocusBehavior(sfxRange);
    ...
    keysTitle.textContent = 'Teclas padrão de jogabilidade';
