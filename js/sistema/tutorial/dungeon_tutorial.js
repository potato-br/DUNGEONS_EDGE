(function(){
  ...
  welcomeIntroText: 'Bem-vindo à dungeon. É aqui que sua jornada tomará forma e onde suas muitas tentativas de exploração irão acontecer. Vamos começar com o básico.',

  
  learningMovementTitle: 'Aprendendo a Se Mover',
  learningMovementText: 'Vamos primeiro aprender a se movimentar e se acostumar com sistemas básicos de controle do jogo.',
  ...
  abilityIntroductionText: 'Agora vamos aprender a usar a habilidade principal do seu personagem. Se você se lembrar, na loja vimos que ela é um simples avanço que te dá imunidade a dano durante a execução e pós-execução por uns segundos de uma experimentada.',
  ...
  uiExplanationInitText: 'Ótimo! Agora você já sabe o básico. Ainda tem coisas avançadas e coisas que serão desbloqueadas com seu progresso para aprender (por exemplo: combos de movimentação), mas com esse básico você conseguirá se virar por um tempo. Vamos seguir para conhecer os elementos da sua tela.',
  ...
  abilityUIExplanationText: 'Essa é sua habilidade disponível atualmente. Fique de olho nela para saber quando sua habilidade estiver pronta para uso novamente. Espere o ícone se completar para saber que está pronta para uso novamente.',

  extraAbilityUIInfoTitle: 'UI: outras Habilidades',
  extraAbilityUIInfoText: 'Essa área também mostrará informações sobre outros atributos que você terá, como outras habilidades ou vidas. Fique de olho nela durante suas tentativas na dungeon.',

  
  survivalChallengeTitle: 'Hora da prática!',
  survivalChallengeText: 'Agora é hora de testar tudo o que aprendeu! Seu objetivo é tentar descer as plataformas, desviar dos inimigos e pegar moedas para gastar na loja. Boa sorte!',
