...
function checkVoidFall() {
  if (player.y > screenHeight && !isRespawning && gameState === "jogando") {
    ...
    // Se estiver em qualquer fase de prática do tutorial, apenas respawn sem perder vida
    if (typeof DungeonTutorial !== 'undefined' && ['practice_arrows','practice_ad','practice_shift'].includes(DungeonTutorial._stage)) {
      respawnPlayer();
      return;
    }
